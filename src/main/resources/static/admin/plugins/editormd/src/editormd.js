;(function(factory) {
    ...
    editormd.prototype    = editormd.fn = {
         ...
         * @returns {Object} return processing object sequence
         */
        ...
        createInfoDialog: function() {
            ...
            var infoDialogHTML = [
                ...
                "<h1><i class=\"editormd-logo editormd-logo-lg editormd-logo-color\"></i> "+ editormd.title + "<small>v" + editormd.version + "</i> small></h1>",
                ...
                text = text.replace(new RegExp(matchs[i]), function($1, $2){
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            return "<img src=\"" + editormd.emoji.path + src + editormd.emoji.ext + "\" class=\"emoji\" title=\"&#58;" + name + "&#58 ;\" alt=\"&#58;" + name + "&#58;\" />";
                        }
                    }
                });
            }
     ...
     * @param {Element} container Insert the container element of TOC
